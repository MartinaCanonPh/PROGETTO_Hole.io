...
public class Options extends JPanel{
			...
			case 3:
				...
				optionsLabels.get(i).addMouseListener(new MouseListener() {
					...
					public void mousePressed(MouseEvent e) {
						clicked=(!clicked);
						if(clicked){
							optionsLabels.get(index3).setIcon(yes);
							Scene.AiModeOn=true;
						}
						else {
							optionsLabels.get(index3).setIcon(nope);
							Scene.AiModeOn=false;
						}						
					}
	...
	public Options() {
		...
		nope=new ImageIcon("assets"+File.separator+"imagesOptions"+File.separator+"aimode_off.png");
		yes=new ImageIcon("assets"+File.separator+"imagesOptions"+File.separator+"aimode_on.png");
