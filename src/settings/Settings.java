...
public class Settings {
	...
	public final static String edificeImg=("assets"+File.separator+"images"+File.separator+"edifice.png");
	
	public final static ImageIcon scaleIcon(ImageIcon icon, int width, int height, int grow_up) {
